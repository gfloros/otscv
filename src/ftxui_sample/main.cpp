...
// configuration step. It creates a namespace called `otscv`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", otscv::cmake::project_name, otscv::cmake::project_version) };
